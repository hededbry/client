  ...
  <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
        <form class="space-y-6" method="POST" @submit.prevent="handleSubmit">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm/6">
              <a href="#" class="font-semibold text-cyan-600 hover:text-indigo-500">Forgot password?</a>
            </div>
          </div>

          <div>
            <button type="submit" class="flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Sign in</button>
          </div>
        </form>
        ...
        <div>
          <div class="mt-10 flex items-center gap-x-6">
            ...
            <p class="text-nowrap text-sm/6 font-medium text-cyan-900">Or continue with</p>
            <div class="w-full flex-1 border-t border-gray-200"></div>
          </div>
      ...
      <p class="mt-10 text-center text-sm/6 text-gray-500">
        Not a member?
        {{ ' ' }}
        <a href="#" class="font-semibold text-cyan-600 hover:text-cyan-500">Start a 14 day free trial</a>
      </p>
    </div>
  </div>
</template>
